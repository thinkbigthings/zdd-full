...
public class ApiVersionInterceptorTest {
    ...
    public void missingApiVersionHeader() {
        ...
        assertEquals(properties.getApiVersion().toString(), response.getHeader(API_VERSION));
    }

    @Test
    public void matchingApiVersionHeader() {

        request.addHeader(API_VERSION, String.valueOf(properties.getApiVersion()));
    ...
    public void outdatedApiVersionHeader() {
        ...
        request.addHeader(API_VERSION, String.valueOf(properties.getApiVersion() - 1));
