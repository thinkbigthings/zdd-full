...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleIncompatibleClient(IncompatibleClientVersionException ex) {
        return new ResponseEntity<>(getBody(NOT_ACCEPTABLE, ex, ex.getMessage()), new HttpHeaders(), NOT_ACCEPTABLE);
    }
